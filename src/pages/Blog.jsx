...
export default function Blog() {
  ...
  // Calculate paginated collection
  ...
  // Unified Scroll Handler (Lenis-aware)
  ...
  return (
    <div className="min-h-screen bg-surface-light dark:bg-surface-dark text-primary-light dark:text-primary-dark pt-32 pb-24 transition-colors duration-300">
      <div className="layout-container">
        ...
        {/* Section Header */}
        <SectionHeader
          tag="STATUTORY KNOWLEDGE DESK"
          title="Tax & Legal Insights"
          subtitle="Directives, procedural notice defenses, and regulatory analyses curated by Matrix Tax Solutions."
        />
        ...
        {/* Card Grid with Stable Minimum Height */}
