...
function BlogCard({ post, index }) {
  ...
  return (
    ...
    >
      <article className="glass-card rounded-3xl p-5 sm:p-6 flex flex-col justify-between border border-theme [@media(hover:hover)]:hover:border-black/40 [@media(hover:hover)]:dark:hover:border-white/40 transition-all duration-200 shadow-sm [@media(hover:hover)]:hover:shadow-xl relative overflow-hidden transform-gpu h-full">
        <div>
        ...
        <div className="pt-4 border-t border-theme flex items-center justify-between text-secondary-light dark:text-secondary-dark mt-auto">
