...
function BlogCard({ post, index, onClick }) {
  ...
  return (
    <article
      ...
      className="glass-card rounded-3xl p-5 sm:p-6 flex flex-col justify-between border border-theme hover:border-black/40 dark:hover:border-white/40 transition-all duration-200 group cursor-pointer shadow-sm hover:shadow-xl relative overflow-hidden transform-gpu"
    >
      <div>
        {/* Category Tag + Serial Index */}
        ...
        {/* Headline */}
        <h3 className="font-serif text-xl sm:text-2xl font-light text-primary-light dark:text-primary-dark group-hover:text-neutral-500 dark:group-hover:text-neutral-300 transition-colors duration-200 leading-snug mb-3">
          {post.title}
        </h3>
      ...
      <div className="pt-4 border-t border-theme flex items-center justify-between text-secondary-light dark:text-secondary-dark">
        ...
        <div className="flex items-center gap-1.5 font-mono text-xs font-bold tracking-wider uppercase text-primary-light dark:text-primary-dark group-hover:translate-x-1 transition-transform duration-200">
