      ...
      {isSubmitted ? (
        ...
        >
          ...
          <p className="font-body font-light text-secondary-light dark:text-secondary-dark max-w-md mx-auto mb-8 leading-relaxed">
            Thank you, <span className="font-medium text-primary-light dark:text-primary-dark">{fullName}</span>. The secretariat will confirm court diary availability for <span className="font-medium text-primary-light dark:text-primary-dark">{selectedDate} Aug at {selectedTime}</span> and contact you shortly.
          </p>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-3.5">
              ...
              >
                ...
                <div>
                  ...
                  <span className="font-serif text-base font-light">Chamber Visit</span>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-theme flex flex-col gap-4">
            ...
            <textarea
              rows={3}
              placeholder="BRIEF CASE QUERY / DOCKET REFERENCE (OPTIONAL)"
              value={notes}
